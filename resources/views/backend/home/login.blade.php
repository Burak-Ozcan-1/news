...
<div class="login-box">
    <div class="login-logo">
        <a style="color:white;" href="{{route('home.index')}}"><b>BRK</b> YAZILIM</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Kullanıcı Adı Ve Şifrenizi Giriniz!</p>
        {{-- eğer şifre hatalı ise error verir. --}}
        ...
        @endif
        <form action="{{route('nedmin.Authenticate')}}" method="post" enctype="multipart/form-data">
            @csrf
